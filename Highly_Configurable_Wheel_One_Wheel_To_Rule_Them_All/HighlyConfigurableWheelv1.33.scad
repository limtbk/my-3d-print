...
tireID         = 55;    // Internal diameter (ID) -- How wide is the inside opening? 
...
numberOfSpokes    = 19;          // Number of "spokes." Set this to three if you're doing the biohazard design
spokeWidth        = 1.2;          // This is how wide each spoke is.
proportion        = [1.4,1.4];  // proportion to rim, proportion of width
curvature         = 0.9;       // For "spiral", this is how curvey the spokes are. >0, but <=1, where 
                                //     1 is a half circle
...
shaftDiameter        = 4.6;          // The diameter of the motor shaft
shaftFlatDiameter    = 3.8;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
